...
- One player and a persistent thumbnail selector switch the active Source video. Navigating to a Clip switches to its Source video and seeks to its start. Loading or dropping a video adds it; starting over is a distinct New Analysis action.
