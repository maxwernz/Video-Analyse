...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("/Users/max/development/video_player/icons/record.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon4.addPixmap(QtGui.QPixmap("/Users/max/development/video_player/icons/record_action.svg"), QtGui.QIcon.Normal, QtGui.QIcon.On)
