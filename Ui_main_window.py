...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("/Users/max/development/video_player/icons/record.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon3.addPixmap(QtGui.QPixmap("/Users/max/development/video_player/icons/record_action.svg"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.clipButton.setIcon(icon3)
